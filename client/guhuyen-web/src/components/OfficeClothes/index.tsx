...
import lady1 from '../../images/Blog2.jpg'
import lady2 from '../..//images/Collection2.mp4'
...
const officeClothes = () =>{
    ...
    return (
        <div className="container office-clothes" id="clothes">
            <h2>ĐỒ CÔNG SỞ BÁN CHẠY NHẤT</h2>
