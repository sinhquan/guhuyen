        ...
        <footer className="container-fluid">
            <div className="footerContent row">
                ...
                <div className="footerItem col-lg-3 col-md-6">
                    ...
                    <p><Link to="#clothes">Thông tin nhà may GuHuyen</Link></p>
                ...
                <div className="footerItem col-lg-3 col-md-6">
                    ...
                    <p>
                        ...
                        <Link to="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-instagram" viewBox="0 0 30 30">
                        ...
                        <Link to="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-google" viewBox="0 0 30 30">
                ...
                <div className="footerItem col-lg-3 col-md-6">
                    ...
                    <div className="input-group mb-3">
                        <input type="text" className="form-control" placeholder="Nhập email?" aria-label="Recipient's username" aria-describedby="button-addon2" />
